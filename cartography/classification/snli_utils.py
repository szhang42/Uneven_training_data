...
class SNLIProcessor(DataProcessor):
    ...
    def get_finetune_examples(self, data_dir):
        """See base class."""
        return self.get_examples(os.path.join(data_dir, "finetune.tsv"), "finetune")

    def get_unlabel_examples(self, data_dir):
        """See base class."""
        return self.get_examples(os.path.join(data_dir, "unlabel.tsv"), "unlabel")
